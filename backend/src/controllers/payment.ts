...
export const createCoupon = async (req: Request<{}, {}, NewCouponRequestBody>, res: Response, next: NextFunction) => {
    try {
...
export const getSingleCoupon = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getDiscount = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if(!code) return next( new ErrorHandler(`Please provide coupon code`, StatusCodes.BAD_REQUEST));
